                ...
                void *(*start_routine)(void*), void* arg)
{
    ...
    int ret = do_lunaix_syscall(__SYSCALL_th_create, &th_info, __pthread_routine_wrapper);

    if (ret) {
        return ret;
    }

    void** th_stack = (void**) (th_info.th_stack_top - 16); 
...
{
    return do_lunaix_syscall(__SYSCALL_th_exit, thread, value_ptr);
}
